...
public class CaseDAO extends BaseDAO{
	...
	public void deleteById(Serializable id) {
        super.deleteById(Case.class, id);
    }
    ...
    public Object get(Serializable id) {
    	Object o = super.get(Case.class, id);
		return o;
    }

   
	public Object getByNProperty(String... strs) {
    	Object o = super.getByNProperty(Case.class, strs);
		return o;
    }

	public Object getUniqueByProperty(String pName, Object pValue) {
    	Object o = super.getUniqueByProperty(Case.class, pName, pValue);
		return o;
    }
	...
	public Object getUniqueBySql(String sql) {
    		Object o = super.getUniqueBySql(sql, Case.class);
    	return o;
    }
	...
	public List getList() {
    	List list = super.getList(Case.class);
    	return list;
    }
	...
	public List getListByProperty(String pName,
            Object pValue) {
    	List list = super.getListByProperty(Case.class, pName, pValue);
    	return list;	    	
    }
	...
	public List getListByProperty(String pName, Object pValue, String condition) {
    	List list = super.getListByProperty(Case.class, pName, pValue, condition);
    	return list;
    }
	...
	public List getListByNProperty(String... strs) {
    	List list = super.getListByNProperty(Case.class, strs);
    	return list;
    }
	...
	public List getListBySql(String sql) {
    	List list = super.getListBySql(sql, Case.class);
    	return list;
    }
	...
	public void getListByPage(PageUtil pageUtil) {
        super.getListByPage(Case.class, pageUtil);
    }
