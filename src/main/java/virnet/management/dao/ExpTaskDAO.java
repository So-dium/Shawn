...
public class ExpTaskDAO extends BaseDAO{
	 public boolean add(ExpTask obj) {
        return super.add(obj);
    }  

   
    public void delete(ExpTask obj) {
        super.delete(obj);
    }

	public void deleteById(Serializable id) {
        super.deleteById(ExpTask.class, id);
    }

   
    public boolean update(ExpTask obj) {
    	return super.update(obj);
    }

   
    public Object get(Serializable id) {
    	Object o = super.get(ExpTask.class, id);
		return o;
    }

   
	public Object getByNProperty(String... strs) {
    	Object o = super.getByNProperty(ExpTask.class, strs);
		return o;
    }

	public Object getUniqueByProperty(String pName, Object pValue) {
    	Object o = super.getUniqueByProperty(ExpTask.class, pName, pValue);
		return o;
    }
	...
	public Object getUniqueBySql(String sql) {
    		Object o = super.getUniqueBySql(sql, ExpTask.class);
    	return o;
    }
	...
	public List getList() {
    	List list = super.getList(ExpTask.class);
    	return list;
    }
	...
	public List getListByProperty(String pName,
            Object pValue) {
    	List list = super.getListByProperty(ExpTask.class, pName, pValue);
    	return list;	    	
    }
	...
	public List getListByProperty(String pName, Object pValue, String condition) {
    	List list = super.getListByProperty(ExpTask.class, pName, pValue, condition);
    	return list;
    }
	...
	public List getListByNProperty(String... strs) {
    	List list = super.getListByNProperty(ExpTask.class, strs);
    	return list;
    }
	...
	public List getListBySql(String sql) {
    	List list = super.getListBySql(sql, ExpTask.class);
    	return list;
    }
