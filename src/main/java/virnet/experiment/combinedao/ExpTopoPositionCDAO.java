...
public class ExpTopoPositionCDAO {
	...
	// 删除一个实验的所有拓扑位置信息
	public void deleteAllPositionInfo(Integer expId,Integer expTaskOrder) {
		...
		List<ExpTopoPosition> plist = this.tpDAO.getListByProperty("expTopoId", topoId);
		try {
			// 删除以往记录
			int i = 0;
			while (i != plist.size()) {
