...
public class ResultTopoDAO extends BaseDAO{
	 public boolean add(ResultTopo obj) {
        return super.add(obj);
    }  

   
    public void delete(ResultTopo obj) {
        super.delete(obj);
    }

	public void deleteById(Serializable id) {
        super.deleteById(ResultTopo.class, id);
    }

   
    public boolean update(ResultTopo obj) {
    	return super.update(obj);
    }

   
    public Object get(Serializable id) {
    	Object o = super.get(ResultTopo.class, id);
		return o;
    }

   
	public Object getByNProperty(String... strs) {
    	Object o = super.getByNProperty(ResultTopo.class, strs);
		return o;
    }

	public Object getUniqueByProperty(String pName, Object pValue) {
    	Object o = super.getUniqueByProperty(ResultTopo.class, pName, pValue);
		return o;
    }
	...
	public Object getUniqueBySql(String sql) {
    		Object o = super.getUniqueBySql(sql, ResultTopo.class);
    	return o;
    }
	...
	public List getList() {
    	List list = super.getList(ResultTopo.class);
    	return list;
    }
	...
	public List getListByProperty(String pName,
            Object pValue) {
    	List list = super.getListByProperty(ResultTopo.class, pName, pValue);
    	return list;	    	
    }
	...
	public List getListByProperty(String pName, Object pValue, String condition) {
    	List list = super.getListByProperty(ResultTopo.class, pName, pValue, condition);
    	return list;
    }
	...
	public List getListByNProperty(String... strs) {
    	List list = super.getListByNProperty(ResultTopo.class, strs);
    	return list;
    }
	...
	public List getListBySql(String sql) {
    	List list = super.getListBySql(sql, ResultTopo.class);
    	return list;
    }
