...
public class ResultConfigDAO extends BaseDAO{
	 public boolean add(ResultConfig obj) {
        return super.add(obj);
    }  

   
    public void delete(ResultConfig obj) {
        super.delete(obj);
    }

	public void deleteById(Serializable id) {
        super.deleteById(ResultConfig.class, id);
    }

   
    public boolean update(ResultConfig obj) {
    	return super.update(obj);
    }

   
    public Object get(Serializable id) {
    	Object o = super.get(ResultConfig.class, id);
		return o;
    }

   
	public Object getByNProperty(String... strs) {
    	Object o = super.getByNProperty(ResultConfig.class, strs);
		return o;
    }

	public Object getUniqueByProperty(String pName, Object pValue) {
    	Object o = super.getUniqueByProperty(ResultConfig.class, pName, pValue);
		return o;
    }
	...
	public Object getUniqueBySql(String sql) {
    		Object o = super.getUniqueBySql(sql, ResultConfig.class);
    	return o;
    }
	...
	public List getList() {
    	List list = super.getList(ResultConfig.class);
    	return list;
    }
	...
	public List getListByProperty(String pName,
            Object pValue) {
    	List list = super.getListByProperty(ResultConfig.class, pName, pValue);
    	return list;	    	
    }
	...
	public List getListByProperty(String pName, Object pValue, String condition) {
    	List list = super.getListByProperty(ResultConfig.class, pName, pValue, condition);
    	return list;
    }
	...
	public List getListByNProperty(String... strs) {
    	List list = super.getListByNProperty(ResultConfig.class, strs);
    	return list;
    }
	...
	public List getListBySql(String sql) {
    	List list = super.getListBySql(sql, ResultConfig.class);
    	return list;
    }
