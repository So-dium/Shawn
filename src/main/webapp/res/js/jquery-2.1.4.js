	...
	if ( (support.qsa = rnative.test( doc.querySelectorAll )) ) {
		...
		assert(function( div ) {
			...
			if ( !div.querySelectorAll([selected]).length ) {
			 ...
			 Support Chrome29, Android4.2+, Safari7.0+, iOS7.0+, PhantomJS1.9.7+
...
function Data() {
	 Support Android4,
	 Old WebKit does not have Object.preventExtensionsfreeze method,
...
var
	rkeyEvent = ^key,
	rmouseEvent = ^(mousepointercontextmenu)click,
...
(function() {
	...
	container.style.cssText = border0;width0;height0;top0;left-9999px;margin-top1px; +
		positionabsolute;
	...
	function computePixelPositionAndBoxSizingReliable() {
		div.style.cssText =
			...
			-webkit-box-sizingborder-box;-moz-box-sizingborder-box; +
			box-sizingborder-box;displayblock;margin-top1%;top1%; +
			border1px;padding1px;width4px;positionabsolute;
		div.innerHTML = ;
		...
		jQuery.extend( support, {
			...
			reliableMarginRight function() {
				...
				marginDiv.style.cssText = div.style.cssText =
					 Support Firefox29, Android 2.3
					 Vendor-prefix box-sizing
					-webkit-box-sizingcontent-box;-moz-box-sizingcontent-box; +
					box-sizingcontent-box;displayblock;margin0;border0;padding0;
...
var xhrId = 0,
 ...
 See httpssupport.microsoft.comkb2856746 for more info
...
jQuery.fn.extend({
	...
	position function() {
		...
		var offsetParent, offset,
		 ...
		 Fixed elements are offset from window (parentOffset = {top0, left 0}, because it is its only offset parent
