			...
			<div class="web_login" id="web_login">
				<div class="login-box">
					<div class="login_form">
						<form action="userManagement.jsp" name="loginform"
							...
							<div class="groupArea" id="groupArea">
								<label class="input-tips" for="p">组别：</label>
								<div class="inputOuter" id="pArea">
									<input type="text" id="p" name="workGroup" class="inputstyle" />
								</div>
							</div>
